...
impl TypeChecker {
    ...
    fn default_env() -> TypeEnv {
        ...
        env.set("choice".to_string(), Type::Function(vec![Type::List(Box::new(Type::Any))], Box::new(Type::Any)));
        env.set("shuffle".to_string(), Type::Function(vec![Type::List(Box::new(Type::Any))], Box::new(Type::Null)));
        ...
        env.set("dict".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Dictionary(Box::new(Type::Any), Box::new(Type::Any)))));
        ...
        env.set("ascii".to_string(), Type::Function(vec![Type::Any], Box::new(Type::String)));
        env.set("repr".to_string(), Type::Function(vec![Type::Any], Box::new(Type::String)));
        ...
        env.set("sqrt".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        env.set("pow".to_string(), Type::Function(vec![Type::Any, Type::Any], Box::new(Type::Any)));
        env.set("exp".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        env.set("log".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        ...
        env.set("sin".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        env.set("cos".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        env.set("tan".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        ...
        env.set("copysign".to_string(), Type::Function(vec![Type::Any, Type::Any], Box::new(Type::Any)));
        ...
        env.set("isinf".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Bool)));
        env.set("isnan".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Bool)));
        env.set("isfinite".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Bool)));
        env.set("erf".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        env.set("erfc".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        env.set("gamma".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        env.set("lgamma".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        ...
        // List
        env.set("append".to_string(), Type::Function(vec![Type::List(Box::new(Type::Any)), Type::Any], Box::new(Type::Null)));
        env.set("extend".to_string(), Type::Function(vec![Type::List(Box::new(Type::Any)), Type::List(Box::new(Type::Any))], Box::new(Type::Null)));
        env.set("pop".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Any)));
        env.set("remove".to_string(), Type::Function(vec![Type::List(Box::new(Type::Any)), Type::Any], Box::new(Type::Null)));
        env.set("insert".to_string(), Type::Function(vec![Type::List(Box::new(Type::Any)), Type::Int, Type::Any], Box::new(Type::Null)));
        env.set("clear".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Null)));
        env.set("reverse".to_string(), Type::Function(vec![Type::Any], Box::new(Type::Null)));
        env.set("sort".to_string(), Type::Function(vec![Type::List(Box::new(Type::Any))], Box::new(Type::Null)));
        ...
        // Set
        env.set("add".to_string(), Type::Function(vec![Type::Set(Box::new(Type::Any)), Type::Any], Box::new(Type::Null)));
        env.set("discard".to_string(), Type::Function(vec![Type::Set(Box::new(Type::Any)), Type::Any], Box::new(Type::Null)));
        ...
        env.set("update".to_string(), Type::Function(vec![Type::Dictionary(Box::new(Type::Any), Box::new(Type::Any)), Type::Any], Box::new(Type::Null)));
        env.set("fromkeys".to_string(), Type::Function(vec![Type::List(Box::new(Type::Any)), Type::Any], Box::new(Type::Dictionary(Box::new(Type::Any), Box::new(Type::Any)))));
        ...
        env.set("eye".to_string(), Type::Function(vec![Type::Int], Box::new(Type::Tensor)));
        env.set("diag".to_string(), Type::Function(vec![Type::Tensor], Box::new(Type::Tensor)));
        env.set("trace".to_string(), Type::Function(vec![Type::Tensor], Box::new(Type::Float)));
        ...
        env.set("clip".to_string(), Type::Function(vec![Type::Tensor, Type::Float, Type::Float], Box::new(Type::Tensor)));
        env.set("norm".to_string(), Type::Function(vec![Type::Tensor, Type::Float], Box::new(Type::Float)));
