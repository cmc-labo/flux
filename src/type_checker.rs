...
impl TypeChecker {
    ...
    fn default_env() -> TypeEnv {
        ...
        env.set("update".to_string(), Type::Function(vec![Type::Dictionary(Box::new(Type::Any), Box::new(Type::Any)), Type::Dictionary(Box::new(Type::Any), Box::new(Type::Any))], Box::new(Type::Null)));
        env.set("bin".to_string(), Type::Function(vec![Type::Int], Box::new(Type::String)));
        env.set("oct".to_string(), Type::Function(vec![Type::Int], Box::new(Type::String)));
        env.set("hex".to_string(), Type::Function(vec![Type::Int], Box::new(Type::String)));
        env.set("eye".to_string(), Type::Function(vec![Type::Int, Type::Int], Box::new(Type::Tensor)));
        env.set("diag".to_string(), Type::Function(vec![Type::Tensor, Type::Int], Box::new(Type::Tensor)));
